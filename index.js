import{S as W,N as J,P as U,a as w,i as g,r as Y,A as se}from"./assets/vendor-B_nRCiHV.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))u(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const y of l.addedNodes)y.tagName==="LINK"&&y.rel==="modulepreload"&&u(y)}).observe(document,{childList:!0,subtree:!0});function o(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function u(s){if(s.ep)return;s.ep=!0;const l=o(s);fetch(s.href,l)}})();const p={openMobileMenu:document.querySelector(".js-open-mobile-menu"),closeMobileMenu:document.querySelector(".js-close-mobile-menu"),mobileMenu:document.querySelector(".js-mobile-menu"),logoMobileMenu:document.querySelector(".js-logo-mobile-menu"),linkMobileMenu:document.querySelectorAll(".js-mobile-menu-link"),btnShoppingMobileMenu:document.querySelector(".js-mobile-menu-shopping-btn"),mobileMenuBody:document.querySelector("body")};p.logoMobileMenu.addEventListener("click",P);p.btnShoppingMobileMenu.addEventListener("click",P);p.openMobileMenu.addEventListener("click",B);p.closeMobileMenu.addEventListener("click",B);document.addEventListener("keydown",B);function B(e){if(p.mobileMenu.classList.contains("is-open")&&e.key==="Escape"){p.mobileMenu.classList.remove("is-open"),p.mobileMenuBody.classList.remove("no-scroll");return}e.type==="click"&&(p.mobileMenu.classList.toggle("is-open"),p.mobileMenuBody.classList.toggle("no-scroll"))}p.linkMobileMenu.forEach(e=>{e.addEventListener("click",P)});function P(){p.mobileMenu.classList.remove("is-open"),p.mobileMenuBody.classList.remove("no-scroll")}window.innerWidth>=768&&new W(".about-swiper",{modules:[J,U],slidesPerView:2,spaceBetween:24,speed:800,navigation:{nextEl:".about-btn-next",prevEl:".about-btn-prev"},pagination:{el:".about-pagination",clickable:!0,bulletClass:"about-pagination-bullet",bulletActiveClass:"about-pagination-bullet-active"},breakpoints:{768:{slidesPerView:2,spaceBetween:20},1280:{slidesPerView:2,spaceBetween:24}}});const v="https://deserts-store.b.goit.study/api";async function re(e={}){const{data:t}=await w.get(`${v}/desserts`,{params:e});return t}async function ie(e){const{data:t}=await w.get(`${v}/desserts/${e}`);return t}async function ae(){const{data:e}=await w.get(`${v}/categories`);return e}async function ce(e,t){const{data:o}=await w.get(`${v}/feedbacks?limit=${e}&page=${t}`);return o}async function de(e){const{data:t}=await w.post(`${v}/orders`,e);return t}const le=/^(?=.{5,}$)(?:[\p{L}]|[\p{N}]|\s|[.,!?;:()'])+$/u,c=document.querySelector(".order-backdrop"),d=document.querySelector("#order-form"),A=c==null?void 0:c.querySelector(".close-btn"),b=d==null?void 0:d.querySelector('button[type="submit"]'),m=d==null?void 0:d.querySelector('textarea[name="comment"]');let M=(d==null?void 0:d.dataset.dessertId)||"";function I(){const e=c==null?void 0:c.classList.contains("is-open");document.body.classList.toggle("modal-open",!!e)}function ue(e){!e||typeof e!="string"||(M=e.trim(),d&&(d.dataset.dessertId=M))}function k(e){ue(e),c==null||c.classList.add("is-open"),I()}function q(){c==null||c.classList.remove("is-open"),I()}function x(){if(!m)return;const e=m.value.trim();if(!e){m.setCustomValidity("");return}le.test(e)?m.setCustomValidity(""):m.setCustomValidity("Мінімум 5 символів: літери, цифри, пробіли і знаки . , ! ? ; : ( ) '")}function pe(e){const t=String(e||"").trim().replace(/[\s()\-]/g,""),o=t.startsWith("+")?t.slice(1):t;return/^0\d{9}$/.test(o)?`38${o}`:o}A==null||A.addEventListener("click",q);c==null||c.addEventListener("click",e=>{e.target===c&&q()});document.addEventListener("keydown",e=>{e.key==="Escape"&&(c!=null&&c.classList.contains("is-open"))&&q()});document.addEventListener("order-modal:open",e=>{var t;k(((t=e.detail)==null?void 0:t.dessertId)||"")});document.addEventListener("click",e=>{const t=e.target.closest("[data-order-open]");if(!t)return;const o=t.dataset.dessertId||t.getAttribute("data-dessert-id")||"";k(o)});m==null||m.addEventListener("input",x);m==null||m.addEventListener("blur",x);d==null||d.addEventListener("submit",async e=>{var l,y,j,D;if(e.preventDefault(),x(),!d.checkValidity()){d.reportValidity();return}if(!M){g.error({title:"Помилка",message:"Неможливо оформити замовлення: спочатку оберіть десерт.",position:"topRight",timeout:5e3});return}const{name:t,phone:o,comment:u}=d.elements,s={name:t.value.trim(),phone:pe(o.value),comment:u.value.trim(),dessertId:M};b&&(b.disabled=!0);try{const r=await de(s),$=(r==null?void 0:r.dessert)||(r==null?void 0:r.dessertName)||"десерт",ne=(r==null?void 0:r.orderNumber)||(r==null?void 0:r.id)||(r==null?void 0:r._id)||"невідомий";g.success({title:"Успіх",message:`Ви замовили ${$}, номер вашого замовлення: ${ne}`,position:"topRight",timeout:4e3}),d.reset(),q()}catch(r){const $=((y=(l=r==null?void 0:r.response)==null?void 0:l.data)==null?void 0:y.message)||((D=(j=r==null?void 0:r.response)==null?void 0:j.data)==null?void 0:D.error)||(r==null?void 0:r.message)||"Не вдалося оформити замовлення. Спробуйте ще раз.";g.error({title:"Помилка",message:$,position:"topRight",timeout:5e3})}finally{b&&(b.disabled=!1)}});I();window.openOrderModal=k;const a=document.querySelector("#productModalOverlay"),S=a==null?void 0:a.querySelector(".CloseButton"),E=a==null?void 0:a.querySelector(".OrderButton");let C=null,H="";async function me(e,t=null){if(console.clear(),!!a){if(typeof e=="string"||typeof e=="number"){C=e,t&&(H=t.textContent,t.textContent="Завантаження...",t.disabled=!0);try{const o=await ie(e);_(o)}catch(o){console.error("Помилка завантаження:",o),g.error({title:"Упс!",message:"Не вдалося завантажити дані. Спробуйте пізніше.",position:"topRight",timeout:4e3});return}finally{t&&(t.textContent=H,t.disabled=!1)}}else typeof e=="object"&&e!==null&&(C=e._id,_(e));a.classList.remove("is-hidden"),document.body.style.overflow="hidden",fe()}}function L(){a&&(a.classList.add("is-hidden"),document.body.style.overflow="",ge())}function fe(){S&&S.addEventListener("click",L),a.addEventListener("click",Q),window.addEventListener("keydown",X),E&&E.addEventListener("click",Z)}function ge(){S&&S.removeEventListener("click",L),a.removeEventListener("click",Q),window.removeEventListener("keydown",X),E&&E.removeEventListener("click",Z)}function Q(e){e.target===a&&L()}function X(e){e.code==="Escape"&&L()}function Z(){L(),C?k(C):console.warn("ID десерту не знайдено!")}function _(e){if(!e||!a)return;a.querySelector(".ProductTitle").textContent=e.name||"Десерт",a.querySelector(".ProductPrice").textContent=e.price?`${e.price} грн`:"";const t=a.querySelector("#productRatingContainer");t&&(t.innerHTML="",Y({starSize:20,rating:e.rate||0,element:t,readOnly:!0,starGap:4}));const o=a.querySelector(".ProductImage");o&&(o.src=e.image||"https://placehold.co/450x450?text=No+Image",o.alt=e.name||"Десерт"),a.querySelector(".ProductDescription").textContent=e.description||"";const u=a.querySelector(".ProductIngredients");u&&(u.innerHTML=`<strong>Склад:</strong> ${e.composition||"Інформація відсутня"}`)}const ye="/team-sweet-workshop/assets/sprite-Bu-390yt.svg",we=8,O={_id:"",name:"Всі десерти"},z=["Всі десерти","Італійські десерти","Гарячі десерти","Заварні тістечка","Класичні торти","Легкі десерти","Незвичайні десерти","Французькі тістечка","Фруктові десерти","Холодні десерти","Шоколадні випічки"],n={section:document.querySelector(".dessert-list-section"),radioList:document.querySelector("[data-category-list]"),dropdown:document.querySelector(".dessert-category-dropdown"),dropdownValue:document.querySelector(".dessert-category-dropdown-value"),dropdownList:document.querySelector(".dessert-category-dropdown-list"),dessertList:document.querySelector("[data-dessert-list]"),loadMoreBtn:document.querySelector("[data-load-more]")},i={categories:[O],activeCategory:"",page:1,totalItems:0,isLoading:!1};n.section&&ve();async function ve(){Le(),await V(async()=>{try{const e=await ae();i.categories=ke(e),qe(),await T({replace:!0})}catch(e){N("Не вдалося завантажити десерти. Спробуйте оновити сторінку."),console.error(e)}})}function Le(){var e,t,o,u,s,l;(e=n.radioList)==null||e.addEventListener("change",Se),(t=n.dropdown)==null||t.addEventListener("click",ee),(o=n.dropdown)==null||o.addEventListener("keydown",be),(u=n.dropdownList)==null||u.addEventListener("click",Me),document.addEventListener("click",he),(s=n.loadMoreBtn)==null||s.addEventListener("click",Ee),(l=n.dessertList)==null||l.addEventListener("click",Ce)}function ee(){if(!n.dropdown||!n.dropdownList)return;const e=n.dropdownList.hidden;n.dropdownList.hidden=!e,n.dropdown.classList.toggle("is-open",e),n.dropdown.setAttribute("aria-expanded",String(e))}function R(){!n.dropdown||!n.dropdownList||(n.dropdownList.hidden=!0,n.dropdown.classList.remove("is-open"),n.dropdown.setAttribute("aria-expanded","false"))}function be(e){["Enter"," ","ArrowDown"].includes(e.key)&&(e.preventDefault(),ee()),e.key==="Escape"&&R()}function he(e){!n.dropdown||!n.dropdownList||e.target.closest(".dessert-select-wrap")||R()}async function Me(e){const t=e.target.closest(".dessert-category-dropdown-item");if(!t)return;const o=t.dataset.value;R(),await te(o)}function te(e){if(!(e===i.activeCategory||i.isLoading))return i.activeCategory=e,i.page=1,Oe(),V(async()=>{try{await T({replace:!0})}catch(t){N("Не вдалося завантажити десерти цієї категорії."),console.error(t)}})}async function Se(e){const t=e.target.value;await te(t)}async function Ee(){if(i.isLoading)return;const e=i.page+1;G(!0),await V(async()=>{try{const t=i.page;i.page=e,await T({replace:!1}),i.page=e}catch(t){i.page-=1,N("Не вдалося завантажити наступні десерти."),console.error(t)}}),G(!1)}function Ce(e){const t=e.target.closest(".dessert-card-more");t&&me(t.dataset.id)}function ke(e){const t=new Map(e.map(s=>[s.name,s])),o=z.slice(1).map(s=>t.get(s)).filter(Boolean),u=e.filter(s=>!z.includes(s.name));return[O,...o,...u]}function qe(){const e=[],t=[];for(const o of i.categories)e.push(Ae(o)),t.push($e(o));n.radioList.innerHTML=e.join(""),n.dropdownList.innerHTML=t.join("")}function $e({_id:e,name:t}){return`
    <li
